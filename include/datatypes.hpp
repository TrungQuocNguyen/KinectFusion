...
struct PreprocessedData
{
    ...
    std::vector<GpuMat> color_pyramid;              //for visualizing surface measurements at different scales
    //GpuMat color_map;
    ...
    PreprocessedData(const size_t& size): depth_pyramid(size), filtered_depth_pyramid(size), color_pyramid(size), vertex_pyramid(size), normal_pyramid(size), valid_vertex_mask(size) {} // set number of subsampled pyramid layers 
};
